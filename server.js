...
const allChoices = {
    ...
    sortDepartment: "View All Employees By Department",
    sortManager: "View All Employees By Manager",
...
function prompt() {
    inquirer
        .prompt({
            ...
            choices: [
                promptMessages.allEmployees,
                promptMessages.sortDepartment,
                promptMessages.sortManager,
                promptMessages.addEmployee,
                promptMessages.removeEmployee,
                promptMessages.allRoles,
                promptMessages.exit
            ]
        })
        .then(answer => {
            ...
            switch (answer.menu) {
                case promptMessages.allEmployees:
                    allEmployees();
                    break;

                case promptMessages.sortDepartment:
                    sortDepartment();
                    break;

                case promptMessages.sortManager:
                    sortManager();
                    break;
...
function remove(input) {
    ...
    inquirer.prompt([
        ...
        else if (input === 'role' && answer.action === "yes") allRoles();
        else allEmployees();
